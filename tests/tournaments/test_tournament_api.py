...
from tests.factories import HostProfileFactory, TournamentFactory, UserFactory
...
def test_create_tournament_missing_fields(host_authenticated_client):
    ...
    data = {"title": "Incomplete Tournament"}
...
def test_update_own_tournament(host_authenticated_client, tournament):
    ...
    data = {"title": "Updated Tournament Title", "description": "Updated description"}
